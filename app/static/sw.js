const CACHE_NAME = 'nomad-pi-v2.0.9-radxa-hotfix';
...
const APP_SHELL = [
  ...
  '/js/offline-control.js', '/js/library-health.js', '/js/storage-failover.js', '/js/profile-context.js', '/js/profile-switch.js', '/js/reader-state.js',
