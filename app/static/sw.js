const CACHE_NAME = 'nomad-pi-v2.0.17-photos-private';
...
const APP_SHELL = [
  ...
  '/js/offline-control.js', '/js/download-live.js', '/js/library-health.js', '/js/media-actions.js', '/js/storage-failover.js', '/js/playback-health-ui.js', '/js/profile-context.js', '/js/profile-switch.js', '/js/gallery-photos.js', '/js/gallery-library-guard.js', '/js/reader-state.js', '/js/reader-ui-polish.js',
