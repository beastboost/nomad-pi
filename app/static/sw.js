...
const APP_SHELL = [
  ...
  '/js/offline-control.js', '/js/download-live.js', '/js/library-health.js', '/js/storage-failover.js', '/js/playback-health-ui.js', '/js/profile-context.js', '/js/profile-switch.js', '/js/reader-state.js',
