const CACHE_NAME = 'nomad-pi-v2.0.18-qol';

const APP_SHELL = [
  '/', '/index.html', '/manifest.json', '/css/nocturne.css', '/css/appliance-polish.css', '/css/media-experience.css', '/css/gallery-photos.css', '/css/qol-polish.css',
  ...
  '/js/offline-control.js', '/js/download-live.js', '/js/library-health.js', '/js/media-actions.js', '/js/storage-failover.js', '/js/playback-health-ui.js', '/js/profile-context.js', '/js/profile-switch.js', '/js/gallery-photos.js', '/js/gallery-library-guard.js', '/js/qol-polish.js', '/js/reader-state.js', '/js/reader-ui-polish.js',
